...
/**
 *
 * @ORM\Table(name="filter_config_materials_table")
 * @ORM\Entity(repositoryClass="ApiBundle\Entity\Repository\FilterMaterialRepository")
 */
class FilterMaterial
{
     ...
     *
     *
     * @ORM\ManyToMany(targetEntity="ApiBundle\Entity\FilterConfig", mappedBy="materials")
     */
    private $filterConfigs;
    /**
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="ApiBundle\Entity\NonStandartCover", mappedBy="materials")
     */
    private $nsCovers;
    /**
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="ApiBundle\Entity\Product", mappedBy="materials")
     */
    private $products;
    /**
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="ApiBundle\Entity\Pattern", mappedBy="materials")
     */
    private $patterns;
